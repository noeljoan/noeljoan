...
**Intent → Reasoning → Tools → Validation → Result**
...
`PostgreSQL` · `SQLite` · Structured Engineering Data
...
`Local LLMs` · `Ollama` · `OpenRouter` · `OpenAI-compatible APIs`
...
`Mechanical Engineering` · `Structural Mechanics` · `FKM` · `CAE` · `FEA` · `Engineering Data Management`

---

# 🔗 Integration & Industrial Ecosystems
...
**Mechanical Engineering × Software × Data × AI**
